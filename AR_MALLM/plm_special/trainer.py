...
from munch import Munch  # 将字典转为 Munch
...
class Trainer:
    ...
    def train_step(self, batch):
        ...
        agent_ids, pre_rs, states, actions, returns, timesteps, labels = process_batch(batch, device=self.device)

        actions_pred = self.model(agent_ids, pre_rs, states, actions, returns, timesteps)
