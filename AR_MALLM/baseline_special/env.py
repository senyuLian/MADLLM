...
PACKET_PAYLOAD_PORTION = 0.95 # 有效载荷比
LINK_RTT = 80  # millisec网络往返时间
...
class Environment:
    def __init__(self, all_cooked_time, all_cooked_bw, all_file_names=None, all_mahimahi_ptrs=None, 
        ...
        self.all_mahimahi_ptrs = all_mahimahi_ptrs #指针变量，用于遍历网络跟踪文件的时间和带宽数据
...
#模拟请求指定比特率的视频块，计算下载时间、缓冲区变化关键指标。
